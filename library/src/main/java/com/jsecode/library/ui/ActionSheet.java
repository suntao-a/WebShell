...
public class ActionSheet extends Fragment implements OnClickListener {
    ...
    private View createView() {
        ...
        mBg.setId(R.id.actionsheet_bg_view_id);
    ...
    private void createItems() {
        ...
        if (titles != null) {
            for (int i = 0; i < titles.length; i++) {
                ...
                bt.setId(R.id.actionsheet_cancel_btn_id + i + 1);
        ...
        bt.setId(R.id.actionsheet_cancel_btn_id);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.actionsheet_bg_view_id && !getCancelableOnTouchOutside()) {
            return;
        }
        dismiss();
        if (v.getId() != R.id.actionsheet_cancel_btn_id && v.getId() != R.id.actionsheet_bg_view_id) {
            if (mListener != null) {
                mListener.onOtherButtonClick(this, v.getId() - R.id.actionsheet_cancel_btn_id
                        - 1);
            }
            isCancel = false;
        }
